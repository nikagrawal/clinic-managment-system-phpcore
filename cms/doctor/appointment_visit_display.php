...
{
    $id=$_GET['id'];
    $update="update appointment_table set   Status_id = 'cancel' where appointment_id=$id";
    echo $update;
  exenonQuery($update);
    header("location:appointment_visit_display.php");
}
?>
<!DOCTYPE html>
<html>
