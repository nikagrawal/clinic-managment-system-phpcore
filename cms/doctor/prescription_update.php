...
if(isset($_GET['id']))
{
	...
	$id=$_GET['id'];
	//echo $id;
	$selectQuery="SELECT * FROM prescription WHERE Prescription_id=".$id;
...
{
	updateData("prescription","$id","Prescription_id","");
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="form-group">
                                               ...
                                               <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    <textarea id="txtDiscription" name="txtDiscription" class="form-control textarea-wysihtml5" placeholder="Enter text..." style="width: 100%; height: 200px" value="<?php echo $row['Discription'];?>"></textarea>
