...
$date=date("d/m/y");
   ...
   //insertData("prescription","Prescription_id","");
    $query2="SELECT t1.Prescription_id,p1.patient_name,d1.doctor_name,t1.Date,t1.Discription from prescription as t1,patient as p1,doctor as d1 WHERE t1.patient_id = p1.patient_id and t1.doctor_id = d1.doctor_id
        ";
