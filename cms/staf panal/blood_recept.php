...
$cn=getCon();
$bid = $_GET['bid'];
$query="select t1.Blood_Report_id,p1.lab_name,t1.Hemoglobin,t1.RBC_of_blood,t1.WBC_of_blood,t1.mcv_of_blood,t1.mch_of_blood,t1.Protein,t1.Calcium,t1.Cholesterol,t1.Sodium,p2.patient_name,d1.doctor_name from blood_report as t1,doctor as d1,lab_master as p1,patient as p2 WHERE 
t1.lab_master_id = p1.lab_master_id and
t1.doctor_id = d1.doctor_id and
t1.patient_id  = p2.patient_id  and
t1.Blood_Report_id  = ".$bid;
