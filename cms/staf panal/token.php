                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default bootstrap-admin-no-table-panel">
                                <div class="panel-heading">
                                    <div class="text-muted bootstrap-admin-box-title">Token</div>
                                </div>
                                <?php echo $msg;?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                   ...
                                                   <div id="txtdate1"></div>
                                                     ...
                                                     <div class="form-group">
                                                <label class="col-lg-2 control-label" >Token NO</label>
                                                <div class="col-lg-10">
                                                    <input type="text" class="form-control col-md-6" id="txttoken_no" name="txttoken_no">
                                                    <div id="txttoken_no1"></div>
                                                </div>
                                            </div>
