...
<html>
    ...
    <body class="bootstrap-admin-with-small-navbar">
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                ...
                                <div class="bootstrap-admin-panel-content">
                                    							<?php
		$q="SELECT t1.Token_id, p1.patient_name,d1.doctor_name,t1.date,ti.token_no,s1.Status_name from token as t1,patient as p1
		...
		echo displayData($arr,$q,"token_update.php","token_display.php","");
				?>
                                </div>
                            </div>
                        </div>
