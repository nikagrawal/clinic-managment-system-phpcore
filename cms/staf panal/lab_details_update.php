...
if(isset($_GET['id']))
{
	...
	$id=$_GET['id'];
	//echo $id;
	$selectQuery="SELECT * FROM lab_details WHERE lab_id=".$id;
...
{
	updateData("lab_details","$id","lab_id","");
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default bootstrap-admin-no-table-panel">
                                <div class="panel-heading">
                                    <div class="text-muted bootstrap-admin-box-title">Lab Detail</div>
                                </div>
                                <?php echo $msg;?>
                                          ...
                                          <div class="form-group">
                                               ...
                                               <?php $query="select disease_id,Disease_name from disease";?>
                                                    <select id="cmbdisease_id" class="selectize-select" style="width: 150px" name="cmbdisease_id">
                                                        <?php echo FillComboBox($query,$row['disease_id']);?>
                                                    </select>
                                             ...
                                             <div class="form-group">
                                               ...
                                               <?php $query="select report_name_id,report_name from report_details";?>
                                                    <select id="cmbreport_name_id" class="selectize-select" style="width: 150px" name="cmbreport_name_id">
                                                        <?php echo FillComboBox($query,$row['report_name_id']);?>
                                                    </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    <input type="text" class="form-control datepicker" id="txtReport_date" name="txtReport_date" value="<?php echo $row['Report_date'];?>">
                                           ...
                                           <div class="form-group">
                                               ...
                                               <?php $query="select report_time_id,report_times from report_time";?>
                                                    <select id="cmbreport_time_id" class="selectize-select" style="width: 150px" name="cmbreport_time_id">
                                                        <?php echo FillComboBox($query,$row['report_time_id']);?>
                                                    </select>
