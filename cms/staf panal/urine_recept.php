...
$cn=getCon();
$uid = $_GET['uid'];
$query="select t1.urine_report_id,p1.lab_name,t1.urine_color,t1.sugar_urine,t1.quantity,t1.pus_cells,t1.Epithelial_cells,t1.Crystals,t1.RBC_urine,p2.patient_name,d1.doctor_name from urine_report as t1,lab_master as p1,patient as p2 ,doctor as d1  WHERE 
t1.lab_master_id = p1.lab_master_id and
t1.patient_id  = p2.patient_id  and
t1.doctor_id = d1.doctor_id and
t1.urine_report_id  = ".$uid;
