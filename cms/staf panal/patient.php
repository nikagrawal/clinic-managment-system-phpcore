                                    ...
                                    <form class="form-horizontal" onSubmit="return validate(this);" method="post" enctype="multipart/form-data">
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    <input type="text" class="form-control col-md-6" id="txtpatient_name" name="txtpatient_name">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    <input type="text" class="form-control col-md-6" id="txtpatient_Father_name" name="txtpatient_Father_name">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    <input type="text" class="form-control col-md-6" id="txtpatient_age" name="txtpatient_age">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    <input type="text" class="form-control col-md-6" id="txtpatient_Weight" name="txtpatient_Weight">
                                             ...
                                             <div class="form-group">
                                                <label class="col-lg-2 control-label" for="textarea-wysihtml5">patient Address</label>
                                                <div class="col-lg-10">
                                                    <textarea id="txtpatient_Address" name="txtpatient_Address" class="form-control textarea-wysihtml5" placeholder="Enter text..." style="width: 100%; height: 200px"></textarea>
