...
{
    insertData("daycare_cost","Daycare_Cost_id","");
                                    ...
                                    <form class="form-horizontal" onSubmit="return validate(this);" method="post" enctype="multipart/form-data">
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                <label class="col-lg-2 control-label" >Daycare Cost Name</label>
                                                <div class="col-lg-10">
                                                    <input type="text" class="form-control col-md-6" id="txtDaycare_Cost_name" name="txtDaycare_Cost_name">
                                                    <div id="txtDaycare_Cost_name1"></div>
                                                </div>
                                            </div>
                                             <div class="form-group">
                                                <label class="col-lg-2 control-label" >Daycare Cost Amount</label>
                                                <div class="col-lg-10">
                                                    <input type="number" class="form-control col-md-6" id="txtDaycare_Cost_amount" name="txtDaycare_Cost_amount">
                                                    <div id="txtDaycare_Cost_amount1"></div>
                                                </div>
                                            </div>
