...
{
	insertData("designation_table","designation_id","");
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default bootstrap-admin-no-table-panel">
                                <div class="panel-heading">
                                    <div class="text-muted bootstrap-admin-box-title">Designation Table</div>
                                </div>
                                <?php echo $msg;?>
                                    ...
                                    <form class="form-horizontal" onSubmit="return validate(this);" method="post" enctype="multipart/form-data">
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                <label class="col-lg-2 control-label" >Designation_name</label>
                                                <div class="col-lg-10">
                                                    <input type="text" class="form-control col-md-6" id="txtdesignation_name" name="txtdesignation_name">
