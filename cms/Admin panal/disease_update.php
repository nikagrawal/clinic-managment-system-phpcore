...
if(isset($_GET['id']))
{
	...
	$id=$_GET['id'];
	//echo $id;
	$selectQuery="SELECT * FROM disease WHERE Disease_id=".$id;
...
{
	updateData("disease","$id","Disease_id","");
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default bootstrap-admin-no-table-panel">
                                <div class="panel-heading">
                                    <div class="text-muted bootstrap-admin-box-title">disease</div>
                                </div>
                                <?php echo $msg;?>
                                    ...
                                    <form class="form-horizontal" onSubmit="return validate(this);" method="post" enctype="multipart/form-data">
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    <input type="text" class="form-control col-md-6" id="txtDisease_name" name="txtDisease_name" value="<?php echo $row['Disease_name'];?>">
                                                    <div id="txtDisease_name1"></div>
                                                </div>
                                            </div>
