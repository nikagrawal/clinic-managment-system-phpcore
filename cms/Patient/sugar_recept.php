...
$query="SELECT s1.sugar_report_id,c1.lab_name,s1.Hemoglobin_sugar,s1.tlc,s1.dlc,s1.mcv_sugar,s1.blood_urea,s1.blood_sugar,s1.serum_sodium,s1.serum_potassium,p2.patient_name,d1.doctor_name from sugar_report as s1, lab_master as c1,patient as p2,doctor as d1 WHERE s1.lab_master_id = c1.lab_master_id
        and s1.doctor_id = d1.doctor_id and s1.patient_id  = p2.patient_id  and p2.patient_id='".$_SESSION['userid']."'
        and s1.sugar_report_id=".$_GET['id'];
