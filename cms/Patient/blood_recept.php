...
if(isset($_GET['id']))
{
$query="SELECT s1.Blood_Report_id,c1.lab_name,s1.Hemoglobin,s1.RBC_of_blood,s1.WBC_of_blood,s1.mcv_of_blood,s1.mch_of_blood,s1.Protein,s1.Calcium,s1.Cholesterol,s1.Sodium,p2.patient_name,d1.doctor_name from blood_report as s1, lab_master as c1,patient as p2,doctor as d1 WHERE 
         s1.patient_id  = p2.patient_id and
         s1.doctor_id = d1.doctor_id and
        s1.lab_master_id = c1.lab_master_id and p2.patient_id='".$_SESSION['userid']."'
        and s1.Blood_Report_id=".$_GET['id'];
               ...
               <div class="card" id="abc"> 
                <div class="col-md-12">
                    <div class="page-header" style="color: #F81D2D;">
                         <h2 align="center"><strong>Bood Report <i class="fas fa-notes-medical"></i> </strong></h2>
                    </div>
                    <div class="row">
                        ...
                        <table class="table">
                            ...
                            <tr>
                                    ...
                                    <td class="col-md-4"><i area-hidden="true"></i> <?php echo $row[11]; ?></td>
                                </tr>
                                 <tr>
                                    <td class="col-md-7">Doctor </td>
                                    
                                    <td class="col-md-4"><i area-hidden="true"></i> <?php echo $row[12]; ?></td>
                                </tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="col-md-7">Hemoglobin </td>
                                ...
                                <tr>
                                    <td class="col-md-9">Sodium</td>
                                    <td class="col-md-9">135-145 </td>
                                    <td class="col-md-3"><i area-hidden="true"></i> <?php echo $row[10]; ?></td>
                                </tr>
                            <tr>
