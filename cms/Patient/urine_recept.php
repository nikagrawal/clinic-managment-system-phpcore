...
$query="SELECT s1.urine_report_id,c1.lab_name,s1.urine_color,s1.quantity,s1.pus_cells,s1.Epithelial_cells,s1.Crystals,s1.RBC_urine,p2.patient_name,d1.doctor_name from urine_report as s1, lab_master as c1 ,patient as p2,doctor as d1 WHERE 
            ...
            s1.doctor_id = d1.doctor_id and
             ...
             and s1.urine_report_id=".$_GET['id'];
               ...
               <div class="card" id="abc"> 
                <div class="col-md-12">
                    <div class="page-header" style="color: #F81D2D;">
                         <h2 align="center"><strong>URINE Report <i class="fas fa-notes-medical"></i> </strong></h2>
                    </div>
                    <div class="row">
                        ...
                        <table class="table">
                            <thead>
                             ...
                             <tr>
                                    ...
                                    <td class="col-md-4"><i area-hidden="true"></i> <?php echo $row[9]; ?></td>
                                </tr>
