...
<html>
    <head>
        <title> Doctor Priscription</title>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                              ...
                                              <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    <textarea id="txtDiscription" name="txtDiscription" class="form-control textarea-wysihtml5" placeholder="Enter text..." style="width: 100%; height: 200px" value="<?php  echo $row1[4];?>" readonly > <?php  echo $row1[4];?></textarea>
